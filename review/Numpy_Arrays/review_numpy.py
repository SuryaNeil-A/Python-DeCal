...
bool_filter = filter.astype(bool)
...
# this one!
exoplanet_data = np.loadtxt("/Users/surya/Python-DeCal/review/Numpy_Arrays/exoplanet_observations.csv", delimiter=',') 
...
avg_lc = np.mean(exoplanet_data, axis=1)
